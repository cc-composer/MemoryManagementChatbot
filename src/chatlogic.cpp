...
ChatLogic::ChatLogic(){} //Obsolete Constructor

ChatLogic::~ChatLogic(){} //Obsolete Destructor
            ...
            if (type != tokens.end())
            {
                ...
                if (idToken != tokens.end())
                {
                    ...
                    if (type->second == "NODE")
                    {
                        ...
                        {
                            std::unique_ptr<GraphNode> endNode = std::make_unique<GraphNode>(id);
                            _nodes.emplace_back(std::move(endNode));
